...
int main()
{
    double b = 0.1; // parametar probne valne funkcije
    ...
    fout = fopen("Ep.dat", "w"); // datoteka za pohranu srednjih vrijednosti za različite parametre

    while (b < 1)
    {                // mijenjanje koraka za b je na dnu ove petlje
